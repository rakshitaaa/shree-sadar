      ...
      t(this).bind("tabactivate", function (t, e) {
        ...
        this.each(function () {
          ...
          b
            ...
            b.css({ display: "block", width: o }),
            "vertical" == a.type && l.css("margin-top", "3px"),
            b
              .find(".resp-tabs-container." + a.tabidentify)
              .css("border-color", a.active_content_border_color),
            b
              .find(".resp-tabs-container." + a.tabidentify + " > div")
              .addClass("resp-tab-content")
              .addClass(a.tabidentify),
            (function () {
              i == s && b.addClass("resp-vtabs").addClass(a.tabidentify);
              1 == r && b.css({ width: "100%", margin: "0px" });
              i == c &&
                (b.addClass("resp-easy-accordion").addClass(a.tabidentify),
                b.find(".resp-tabs-list").css("display", "none"));
            })(),
            b
          ...
          b.find(".resp-tab-item").each(function () {
            ...
            b.find(".resp-tab-content." + a.tabidentify).each(function () {
              t(this)
                .attr("aria-labelledby", a.tabidentify + "_tab_item-" + e)
                .css({ "border-color": a.active_border_color }),
                e++;
            }),
              v++;
          });
          var y = 0;
          if ("" != n) {
            var h = n.match(new RegExp(f + "([0-9]+)"));
            null !== h &&
              2 === h.length &&
              (y = parseInt(h[1], 10) - 1) > v &&
              (y = 0);
          }
          t(b.find(".resp-tab-item." + a.tabidentify)[y])
            ...
            !0 === a.closed ||
              ("accordion" === a.closed && !l.is(":visible")) ||
              ("tabs" === a.closed && l.is(":visible")) ||
              (t(b.find(".resp-accordion." + a.tabidentify)[y])
                .addClass("resp-tab-active")
                .css({
              ...
              t(b.find(".resp-tab-content." + a.tabidentify)[y])
                .addClass("resp-tab-content-active")
                .addClass(a.tabidentify)
                .attr("style", "display:block")),
            b.find("[role=tab]").each(function () {
              t(this).click(function () {
                ...
                if (
                  ...
                  return (
                    b
                      .find(".resp-tab-content-active." + a.tabidentify)
                      .slideUp("", function () {
                ...
                if (
                  ...
                  e.hasClass("resp-accordion")
                    ? (b
                        .find(".resp-tab-active." + a.tabidentify)
                        .removeClass("resp-tab-active")
                        .css({
                          "background-color": a.inactive_bg,
                          "border-color": "none",
                  ...
                  var r = window.location.hash,
                    o = (i.split("tab_item-"), "");
                  if ("" != r) {
                    var s = new RegExp(f + "[0-9]+");
                    o = null != r.match(s) ? r.replace(s, o) : r + "|" + o;
                  } else (o = "#" + o), (o = "");
